...
export const MENU_SECTIONS: MenuSection[] = [
  {
    ...
    hero: heroMandi,
    items: [
      { name: "Royal Chicken Mandi", type: "Mandi", price: "₹ 320", note: "Whole leg, 24-hour spiced marinade, saffron rice.", tag: "Signature" },
      { name: "Full Chicken Mandi", type: "Mandi", price: "₹ 590", note: "Serves 3–4. Smoked whole bird, mandi rice, two dips." },
      { name: "Mutton Mandi", type: "Mandi", price: "₹ 480", note: "Bone-in shoulder, slow-smoked four hours." },
      { name: "Full Mutton Mandi", type: "Mandi", price: "₹ 1,240", note: "Serves 4–5. Family platter with dry fruits." },
      { name: "Fish Mandi", type: "Mandi", price: "₹ 420", note: "Seer fish, arabic spice rub, lemon butter rice." },
      { name: "Prawns Mandi", type: "Mandi", price: "₹ 460", note: "Tiger prawns, garlic smoke, ghee rice." },
    ],
  },
  {
    id: "shawaya",
